...
router.post('/spiderchart', tokenChecker, async (req, res) => {
    const activity = await userMethods.spiderchart(req.body);
  const response = {
    "status": "ok",
      "result": activity,
  };
...
router.post('/activitychart', tokenChecker, async (req, res) => {
    const activity = await userMethods.activitychart(req.body);
    const response = {
        "status": "ok",
        "result": activity,
    };
...
router.post('/activityperuser', tokenChecker, async (req, res) => {
    const activity = await userMethods.activityperuser(req.body);
    const response = {
        "status": "ok",
        "result": activity,
    };
...
router.post('/getanalytics', tokenChecker, async (req, res) => {

    const result = await absenceMethods.analyticsuser(req.body);
    const response = {
        "status": "ok",
        "result": result,
    };
